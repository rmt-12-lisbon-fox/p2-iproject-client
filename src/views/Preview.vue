        ...
        >
          ...
          >
            <img
              ...
              :src="data.Tamplate.imgT"
              alt="blog"
            />
            <h1 class="text-center pb-4">{{ data.Tamplate.version }}</h1>
            <div class="flex items-center flex-wrap">
              <button
                ...
                class="
                  ...
                  ml-3
                "
                @click.prevent="viewsInvite(data.id)"
              >
                Views
              </button>
              <button
...
export default {
  ...
  computed: {
    dataInvite() {
      return this.$store.state.dataInvite;
    },
  },
  methods: {
    viewsInvite(id) {
