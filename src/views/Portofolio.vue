...
<!-- aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->
    <div class="container"> <div class=" text-center mt-5 "> <br><br><br><br><br>
        <h1 class="text-dark">Add / Edit your Investment to this Portofolio</h1>
      </div>
      <div class="row ">
                ...
                <form id="contact-form" role="form">
                  <div class="controls">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group"> <label for="form_name">Firstname *</label> <input id="form_name"
                            type="text" name="name" class="form-control" placeholder="Please enter your firstname *"
                            required="required" data-error="Firstname is required."> </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group"> <label for="form_lastname">Lastname *</label> <input id="form_lastname"
                            type="text" name="surname" class="form-control" placeholder="Please enter your lastname *"
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group"> <label for="form_need">Please specify your need *</label> <select
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6"> <input type="submit" class="btn btn-success btn-send pt-2 btn-block "
                          value="Add Porto"> </div>
                      <div class="col-md-6"> <input type="submit" class="btn btn-warning btn-send pt-2 btn-block "
                          value="Edit Porto"> </div>
                    </div>
                  </div>
                </form>
              </div>
