<template>
    <div class="h-14 min-w-full px-8 z-20 fixed bg-third flex justify-between items-center shadow-xl">
      <div>
        <router-link to="/">
          <h2 class="font-mono text-2xl text-primary font-extrabold">Nreview</h2>
        </router-link>
      </div>
