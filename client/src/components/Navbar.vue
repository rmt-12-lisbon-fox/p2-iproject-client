            ...
            <div class="container mx-auto px-6 py-3">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center justify-end w-100">
                        <button @click="toBookmark" v-if="isLoggedIn && isCustomer" class="text-gray-500 focus:outline-none mx-4 sm:mx-0">
                        ...
                        <button @click.prevent="toAdd" v-if="isLoggedIn && !isCustomer" class="text-gray-500 focus:outline-none mx-4 sm:mx-0">
                            Add a Design
                        </button>
...
export default {
  ...
  methods: {
    ...
    toAdd () {
      this.$router.push({ name: 'AddDesign' }).catch(() => {})
    }
  }
}
</script>
