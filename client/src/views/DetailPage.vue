...
export default {
  ...
  computed: {
    ...
    name() {
      return this.countries[this.$route.params.id].name;
    },
    description() {
      return this.countries[this.$route.params.id].description;
    },
    imgUrl() {
      return this.countries[this.$route.params.id].imgUrl;
    },
    mapSrc() {
